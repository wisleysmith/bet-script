...
//http://www.facebook.com/apps/application.php?id=182006978670
	...
	$_SESSION['faceInfo'] = $user_details[0]['uid']; // store session data
...
if ( hasProductInstall && !hasRequestedVersion ) {
	...
	AC_FL_RunContent(
		...
		"height", "100%",
		"align", "middle",
		"id", "kladionicaKlijent",
		"quality", "high",
		"bgcolor", "#869ca7",
		"name", "kladionicaKlijent",
...
<noscript>
  	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			id="kladionicaKlijent" width="100%" height="100%"
			codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab">
			<param name="movie" value="kladionicaKlijent.swf" />
			<param name="quality" value="high" />
			<param name="bgcolor" value="#869ca7" />
			<param name="allowScriptAccess" value="sameDomain" />
			<embed src="kladionicaKlijent.swf" quality="high" bgcolor="#869ca7"
				width="100%" height="100%" name="kladionicaKlijent" align="middle"
				play="true"
				loop="false"
				quality="high"
				allowScriptAccess="sameDomain"
