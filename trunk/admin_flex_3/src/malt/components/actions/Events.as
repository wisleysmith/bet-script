...
package malt.components.actions
{
	...
	public class Events extends Actions
	{
        ...
        public function loadEvents(event):void
        {     
               _serviceEvents.sportId=event.currentTarget.selectedItem.idTable
        	  _serviceEvents.callSelect(resultSelect)
        }
        
        public function resultSport(event:ResultEvent)
        {
        	if(_checkData.validation(event.result)) 
	        { 
 	  	  
 	          component.eventSportCombo.dataProvider=new ArrayCollection(event.result as Array); 
		   
 	  	  	  component.mainDG.dataProvider=	new ArrayCollection( )
 	  	  	  component.mainTab.selectedIndex=0;
 	  	  	  component.call._repData=new ArrayCollection(); 
 		      component.myrep.dataProvider=null;
 		   
 		     
 		      
 		       if(component.call._tabChangeByTable)
	 		   {
	 		      component.call.myrep2.dataProvider=null;
	 		      component.editing.text="";
	 		   }
 	  		 
 	  	     } 
 	  		  event.currentTarget.removeEventListener("result", resultSport);
        }
        ...
        public function constructComponent():void
 		{  
 	        ...
 	        _repData=new ArrayCollection();
 			 _serviceEvents.sportId=1
 			_serviceSport.callSelect(resultSport)
 	   ...
 	   public function changeEventData(event,data:uint):void
 	   {
 	  	 ...
 	  	 public function deleteAlertHandler(event:CloseEvent):void
		 {
 	  	...
 	  	{
 	  		 _serviceEvents.sportId=component.eventSportCombo.selectedItem.idTable;
 	  	...
 	  	{  
 	  		...
 	  		if( component.eventSportCombo.selectedIndex!=-1)
 	  		{
