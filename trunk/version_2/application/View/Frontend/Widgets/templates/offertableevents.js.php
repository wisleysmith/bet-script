...
{ 
	...
	betSlipRecordSet.add({odds:odds,endDate:data['end_date'],event_bets_id:data['event_bets_id'],name:data['event_bets_name'],key:selecting[cellIndex].label,odd_value_id:data[odds_id_string],bets_id:data['bets_id']})
